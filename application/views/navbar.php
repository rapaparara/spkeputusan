  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('dashboard/') ?>">
        ...
        <div class="sidebar-brand-text mx-3">SPKeputusan</div>
      </a>
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item  <?php if($this->uri->segment(2)=="keputusan"){echo "active";}?>">
      ...
      <li class="nav-item  <?php if($this->uri->segment(2)=="alternatif"){echo "active";}?>">
      ...
      <li class="nav-item  <?php if($this->uri->segment(2)=="hitungkriteria"){echo "active";}?>">
        <a class="nav-link" href="<?php echo base_url('dashboard/hitungkriteria') ?>">
          <i class="fas fa-fw fa-table"></i>
          <span>Hitung Kriteria</span></a>
      </li>
      <li class="nav-item  <?php if($this->uri->segment(2)=="hitungalternatif"){echo "active";}?>">
