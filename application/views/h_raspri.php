          ...
          <div class="row">
              ...
              <div class="card shadow mb-4">
                ...
                <form action="aksi_hitung_bobot" method="post">
                  <table class="table">
                    ...
                    <?php 
                    $j = 0;
                    foreach($kriteria as $k) { $j++;?>
                    <tr>
                    <td><?php echo $k->nama_kriteria; ?></td>
                    <?php 
                    $i = 0;
                    foreach($kriteria as $k) { $i++;?>
                    <td><input type="text" name="<?php echo 'k'.$i.$j ?>"></td>
                    <?php } ?>
                    </tr>
                    <?php } ?>
                  </table>
            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <table class="table">
                    <tr><td><b>9</b></td><td>Mutlak lebih penting</td></tr>
                    <tr><td><b>7</b></td><td>Sangat lebih penting</td></tr>
                    <tr><td><b>5</b></td><td>Lebih penting</td></tr>
                    <tr><td><b>3</b></td><td>Cukup penting</td></tr>
                    <tr><td><b>1</b></td><td>Sangat penting</td></tr>
                  </table>
                </div>
              </div>
            </div>
