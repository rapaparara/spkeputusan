          ...
          <div class="row">
                  ...
                  $jum_alternatif = $this->MainModel->tampil_jumlah('id_keputusan = '.$this->input->post('id_keputusan'),'alternatif');
                   ?>
                    <table class="table">
                            ...
                            <?php
                            $i = 0;
                            foreach($alternatif as $a) { $i++?>
                            <tr>
                              <?php $j = 0; ?>
                              <td><?php echo $a->nama_alternatif; ?></td>
                              <?php foreach($kriteria as $k) { $j++?>
                              <td><input type="text" name="<?php echo 'a'.$i.$j ?>"></td>
                              <?php } ?>
                            </tr>
                            <?php } ?>
                    </table>
            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <table class="table">
                    <tr><td><b>1</b></td><td>Sangat kurang</td></tr>
                    <tr><td><b>2</b></td><td>Kurang</td></tr>
                    <tr><td><b>3</b></td><td>Cukup</td></tr>
                    <tr><td><b>4</b></td><td>Baik</td></tr>
                    <tr><td><b>5</b></td><td>Sangat baik</td></tr>
                  </table>
                </div>
              </div>
            </div>
